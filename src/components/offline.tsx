...
//   // rounds = rounds won in current game (0..5)
...
//   // Start a countdown that pauses the game until it finishes.
...
//     stopLoop(); // pause game while countdown is showing
//     console.log("Match winner exists?", matchWinner)
//     if (matchWinner) return;
//     setCurrentRound(roundNum);
//     let count = 3;
//     setRoundCountdown(count);
...
//         setRoundCountdown(null);
//         startLoop(); // now start the game loop after countdown ends
//       } else {
//         setRoundCountdown(count);
//       }
//     }, 1000);
...
//     setMatchWinner(null);
//     setCurrentRound(1);
//     resetRound(); // puck centered with dx/dy set
//     // startRoundCountdown(1); // show countdown and then start game

//     function resize() {
//       console.log("Resizing because of reset")
...
//   // Ensure countdown is cleared on unmount
//   useEffect(() => {
//     return () => {
//       if (countdownIntervalRef.current !== null) {
//         window.clearInterval(countdownIntervalRef.current);
...
//     // Start with a Round 1 countdown (do NOT call startLoop here)
//     // startRoundCountdown will start the loop after countdown ends
//     startRoundCountdown(1);
...
//   // reset puck position (does NOT start the loop)
//   function resetRound() {
//     console.log("Reset puck position")
//     const canvas = canvasRef.current;
//     if (!canvas) return;
//     puckRef.current = {
//       x: canvas.width / 2,
...
//   // Called when rounds are updated to check if game should end
//   function checkRoundWin(nextRounds: Score) {
//     // If someone reached 3 rounds, immediate game end
//     if (nextRounds.you >= ROUNDS_TO_WIN_GAME || nextRounds.opp >= ROUNDS_TO_WIN_GAME) {
//       endGame(nextRounds.you > nextRounds.opp ? 'You' : 'Opponent');
//       return;
//     }
//     // If 5 rounds have been played, end the game
//     if (nextRounds.you + nextRounds.opp >= MAX_ROUNDS_PER_GAME) {
//       const winner =
//         nextRounds.you > nextRounds.opp ? 'You' : nextRounds.opp > nextRounds.you ? 'Opponent' : 'Tie';
//       endGame(winner);
//     }
//   }
...
//     // ensure game paused
//     stopLoop();
//     // clear any countdown that might be present
//     if (countdownIntervalRef.current !== null) {
//       window.clearInterval(countdownIntervalRef.current);
//       countdownIntervalRef.current = null;
//     }
...
//       });
//       resetRound();
//       // No countdown for later rounds
//       if (!matchWinner) startLoop();
//       return;
//     }
//     // opponent scores a round
...
//   //   setCurrentRound(1);
//   //   resetRound();
//   //   // start Round 1 countdown (do not start loop)
//   //   startRoundCountdown(1);
//   // }
//   // function resetMatch() {
//   //   setRounds({ you: 0, opp: 0 });
...
//   //   setCurrentRound(1);
//   //   resetRound();
//   //   startRoundCountdown(1); // countdown only when game restarts
//   // }
